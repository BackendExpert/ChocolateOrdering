                      ...
                      AllItems.map((items, index) => {
                        return (
                          <div key={index} class="md:grid grid-cols-5 px-4 py-5 text-sm text-gray-700 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                              <div class="text-gray-500 dark:text-gray-400">{items.ItemNumber}</div>
                              <div class="text-gray-500 dark:text-gray-400">{items.ItemName}</div>
                              <div class="text-gray-500 dark:text-gray-400">${items.ItemPrice}</div>
                              <div class="text-gray-500 dark:text-gray-400">{items.Stock}</div>
